...
class Project(models.Model):
    ...
    type = models.CharField(
        ...
        help_text="Type de projet (front-end, back-end, etc.)"
    )
    creator = models.ForeignKey(
        User,
        related_name="projects_created",
        on_delete=models.CASCADE,
        help_text="Créateur du projet"
    )
    contributors = models.ManyToManyField(
        Contributor,
        related_name="projects_contributed",
        blank=True,
        help_text="Contributeurs associés au projet"
    )
...
class Issue(models.Model):
    ...
    project = models.ForeignKey(
        ...
        related_name="issues",
        on_delete=models.CASCADE,
        help_text="Projet associé à cette issue"
    )
    creator = models.ForeignKey(
        User,
        related_name="created_issues",
        on_delete=models.CASCADE,
        help_text="Utilisateur qui a créé l'issue"
    )
    assignee = models.ForeignKey(
        ...
        null=True,
        blank=True,
        help_text="Utilisateur assigné à cette issue"
    )
    ...
    created_time = models.DateTimeField(
        auto_now_add=True,
        help_text="Date de création de l'issue"
    )
...
class Comment(models.Model):
    ...
    issue = models.ForeignKey(
        ...
        on_delete=models.CASCADE,
        help_text="Issue associée au commentaire"
    )
    creator = models.ForeignKey(
        User,
        related_name="created_comments",
        on_delete=models.CASCADE,
        help_text="Utilisateur ayant créé le commentaire"
    )
    created_time = models.DateTimeField(
        auto_now_add=True,
